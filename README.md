# StockFlow — Admin Role Package

This ZIP is the **Admin-only** version of the StockFlow Inventory & Stock Management System.
...
- Only the **Admin** operational module is included; other role modules are intentionally excluded so the demo clearly shows this role's work.
...
6. Sign in. The system redirects to the **Admin** dashboard.

## MVC
- Controller: `app/controllers/`
- Model: `app/models/`
- View: `app/views/`
- Role entry pages: `admin/`
